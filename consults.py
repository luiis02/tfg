...
#print(a[0][0])
bd.execute_query("ALTER TABLE pedidos_historicos ADD COLUMN categoria VARCHAR(50);")
...
bd.execute_query("ALTER TABLE pedidos_activos ADD COLUMN categoria VARCHAR(50);")
